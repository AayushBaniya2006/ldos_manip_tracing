...
def launch_setup(context, *args, **kwargs):
    ...
    # MoveIt configuration file path
    # Using ParameterFile ensures proper handling of nested parameters
    moveit_config_file = os.path.join(pkg_ldos_harness, "config", "moveit.yaml")

    # Move group node
    # Use ParameterFile for moveit.yaml to properly handle nested controller configs
